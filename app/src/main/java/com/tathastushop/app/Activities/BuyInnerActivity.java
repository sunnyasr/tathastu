...
public class BuyInnerActivity extends AppCompatActivity implements View.OnClickListener {

    private TextView tvMRP, tvPname, tvDesc, tvPrice, tvWallet, tvTotal, tvSTotal, tvGST, tvQty, tvShipping, tvPCode;
...
//        Glide.with(this).load(APIConfig.BASE_IMAGE + "products/" + getIntent().getStringExtra("pimage")).asBitmap().diskCacheStrategy(DiskCacheStrategy.ALL)
//                .dontAnimate().into(new BitmapImageViewTarget(ivProduct) {
//            @Override
...
//        Toast.makeText(this, "wallet : "+wallet+"\nprice:"+price, Toast.LENGTH_SHORT).show();

        //Check Pincode
        checkpincode(userManager.getPinCode());
...
//                Toast.makeText(BuyInnerActivity.this, ""+response, Toast.LENGTH_SHORT).show();
                ...
                for (int i = 0; i < myViewPagerAdapter.getCount(); i++) {
                    ...
                    dots[i] = new ImageView(BuyInnerActivity.this);
...
//                Toast.makeText(BuyActivity.this, "" + response, Toast.LENGTH_SHORT).show();
                ...
                try {
                    ...
                    int gtotal = shipping + total + ((shipping + total) * gst / 100);
                    tvTotal.setText("₹" + gtotal);
                } catch (JSONException e) {
                    e.printStackTrace();
                }
            ...
            @Override
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(BuyInnerActivity.this, "" + error.getMessage(), Toast.LENGTH_SHORT).show();
            }
        }) {
            @Override
            public Map<String, String> getHeaders() throws AuthFailureError {
    ...
    public void setProgress() {
        kProgressHUD = KProgressHUD.create(BuyInnerActivity.this)
...
//            Toast.makeText(this, "Payment", Toast.LENGTH_SHORT).show();
            if (size.equals("")) {
                ...
                Intent intent = new Intent(getApplicationContext(), PaymentInnerActivity.class);
...
//                    .into(imgDisplay);
            ...
            Glide.with(BuyInnerActivity.this).load(APIConfig.BASE_IMAGE + "products/" + image.getProductimg()).asBitmap().diskCacheStrategy(DiskCacheStrategy.ALL)
            ...
            imgDisplay.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    Intent intent = new Intent(BuyInnerActivity.this, PopProductActivity.class);
